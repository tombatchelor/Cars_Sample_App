...
public class ActionEnquire extends Action {
    ...
    public void saveEnquireForm(EnquireForm enquireForm) {
        Enquiry enquiry = Enquiry.enquiryFromFrom(enquireForm);
        new EnquiryDataLoader().saveEnquiry(enquiry);
    }

    public void getEnquireForm(int enquireFormId) {
        Enquiry enquiry = new EnquiryDataLoader().getEnquiry(enquireFormId);
        EnquireForm enquireForm = Enquiry.formFromEnquiry(enquiry);
    }
}

...
<jsp:include page="/trader/header.jsp" />
<%
try {
			Random r = new Random();
			int i = r.nextInt(999);
			...
			<table>
				<tr>
					<td>
						<table>
							<tr>
								<td class="ad"><b>Finance Centre</b><br>Compare over 400 leading loan suppliers including:<br><br><a href="">Northern Smock</a><br><a href="">Alliance & Lancaster</a><br><a href="">Bresco Loans</a><br>&nbsp;</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="ad"><b>Performance Accessories</b><br>Manufacturer OEM parts from:<br><br><a href="amg.jsp">AMG</a><br><a href="alpina.jsp">Alpina</a><br><a href="mazdaspeed.jsp">MazdaSpeed</a><br><a href="ruf.jsp">Ruf</a><br><a href="gembella.jsp">Gemballa</a><br>&nbsp;</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="ad"><b>Contact Us</b><br><br><a href="">SuperTrader UK</a><br><a href="">FAQ</a><br><a href="">Sitemap</a><br><a href="">Editor</a><br><a href="">Advertising</a><br>&nbsp;</td>
							</tr>
						</table>
					</td>
				</tr>

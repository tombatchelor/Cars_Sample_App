...
<br><input type="text" name="criteria" />&nbsp;
		<input type="image" src="images/search_button.gif"/ align="absmiddle"><br><% if (request.getParameter("criteria") != null) { %><br>Your search '<%=request.getParameter("criteria")%>' returned the following <%=((ArrayList)request.getAttribute("cars")).size()%> results:<% }%></p>
<table>
